...
const unsigned long BUTTON_LONG_PRESS_INTERVAL = 800;
  ...
  const uint8_t gExpanderAddresses[] = {1,2}; //0x27 nie jest używany obecnie
#endif
...
// 2
{1, E(0,0), RELAY_TRIGGER_LOW, -1,"Kinkiet - Drzwi tarasowe"}, //K1K2 PA0
{2, E(0,1), RELAY_TRIGGER_LOW, -1,"Kinkiet - Drzwi wejściowe"}, //K8  PA1
{3, E(0,2), RELAY_TRIGGER_LOW, -1,"ZB1"},                           //PA2
...
{9,  E(0,8), RELAY_TRIGGER_HIGH, -1,"Oś. Korytarz obok łazienki"}, //K7 PB0
{10, E(0,9), RELAY_TRIGGER_HIGH, -1,"Oś. Garderoby"}, //K18             PB1
{11, E(0,10), RELAY_TRIGGER_HIGH, -1,"Oś. Garaż wejście"}, //K24         PB2
{12, E(0,11), RELAY_TRIGGER_HIGH, -1,"Oś. Garaż kotłownia"}, //K24
{13, E(0,12), RELAY_TRIGGER_HIGH, -1,"Oś. Kotłowni"}, //K25
{14, E(0,13), RELAY_TRIGGER_HIGH, -1,""},
{15, E(0,14), RELAY_TRIGGER_HIGH, -1,"Oś. Jadalni"}, //K4
{16, E(0,15), RELAY_TRIGGER_HIGH, -1,"Oś. Spiżarni"}, //K11
...
//MCP 4
{E(1,0), BI_STABLE,  1, -1, -1, "WIATROŁAP WEJŚCIE"}, //W1 - ŚCIANA WIATROŁAPU ZAPLA ŚWIATŁO NAD WEJŚCIEM GŁÓWNYM
{E(1,1), BI_STABLE,  2, -1, -1, "WYJŚCIE NA TARAS"}, //W2 - ZAPALA ŚWIATŁO ZEWNĘTRZNE NA TARASIE KINKIETY K1K2 
{E(1,2), BI_STABLE,  3, -1, -1, "KUCHNIA OKNO"}, //W3 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD OKNEM W KUCHNI
{E(1,3), BI_STABLE,  8, -1, -1, "KUCHNIA ŚRODEK"}, //W3 - ŚCIANA SALONU ZAPALA ŚWIATŁO W KUCHNI
{E(1,4), BI_STABLE,  9, -1, 16, "BAREK"}, //W3 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD BARAKIEM - podwójne kliknięcie włącza światło w spiżarni
{E(1,5), BI_STABLE,  10, -1, -1, "SALON KANAPA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD KANAPĄ
{E(1,6), BI_STABLE,  -1, -1, -1, "SALON TV"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD TV
{E(1,7), BI_STABLE,  -1, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(1,8), BI_STABLE,  1, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(1,9), BI_STABLE,  1, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI PB0
{E(1,10), BI_STABLE,  15, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(1,11), BI_STABLE,  15, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(1,12), BI_STABLE,  15, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(1,13), BI_STABLE,  1, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(1,14), BI_STABLE,  2, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(1,15), BI_STABLE,  3, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI PB7

/*
{E(0,0), BI_STABLE,  1, -1, -1, "WIATROŁAP WEJŚCIE"}, //W1 - ŚCIANA WIATROŁAPU ZAPLA ŚWIATŁO NAD WEJŚCIEM GŁÓWNYM
{E(0,1), BI_STABLE,  2, -1, -1, "WYJŚCIE NA TARAS"}, //W2 - ZAPALA ŚWIATŁO ZEWNĘTRZNE NA TARASIE KINKIETY K1K2 
{E(0,2), BI_STABLE,  3, -1, -1, "KUCHNIA OKNO"}, //W3 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD OKNEM W KUCHNI
{E(0,3), BI_STABLE,  8, -1, -1, "KUCHNIA ŚRODEK"}, //W3 - ŚCIANA SALONU ZAPALA ŚWIATŁO W KUCHNI
{E(0,4), BI_STABLE,  9, -1, 16, "BAREK"}, //W3 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD BARAKIEM - podwójne kliknięcie włącza światło w spiżarni
{E(0,5), BI_STABLE,  10, -1, -1, "SALON KANAPA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD KANAPĄ
{E(0,6), BI_STABLE,  -1, -1, -1, "SALON TV"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO NAD TV
{E(0,7), BI_STABLE,  -1, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(0,8), BI_STABLE,  -1, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(0,9), BI_STABLE,  15, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI PB0
{E(0,10), BI_STABLE,  15, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(0,11), BI_STABLE,  15, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(0,12), BI_STABLE,  15, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(0,13), BI_STABLE,  1, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(0,14), BI_STABLE,  2, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI
{E(0,15), BI_STABLE,  3, -1, -1, "JADALNIA"}, //W4 - ŚCIANA SALONU ZAPALA ŚWIATŁO W JADALNI PB7
